...
import router from './agenciaViajesNode/routes/index.js';

// Importar la configuración de la base de datos
import db from './agenciaViajesNode/config/db.js';
...
app.get('/contacto', (req, res) => {
    res.send(`El servidor está funcionando nuevamente en el puerto ${port}`);
});
